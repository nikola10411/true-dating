...
const unreadMessageTemplate = (displayName, icons) => `
 <!DOCTYPE html
                          ...
                          <tr>
                            <td style="
                              ...
                              <div style="line-height: 140%; text-align: left; word-wrap: break-word">
                                ...
                                <p style="font-size: 14px; line-height: 140%">
                                  Love could be in the air, you have an unread message in your True Dating inbox.
                                </p>
                                <p style="font-size: 14px; line-height: 140%">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 140%">
                                  Log in and find out what it says.
                                </p>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            " align="left">
                              <div style="line-height: 140%; text-align: left; word-wrap: break-word">
                                        ...
                                        <div align="center">
                                          ...
                                          <a href="${process.env.ORIGIN}/login" target="_blank" style="
                                            ...
                                            <span style="display: block; padding: 10px 20px; line-height: 120%">
                                              <strong><span style="font-size: 14px; line-height: 16.8px">Login</span></strong>
                                            </span>
                                          </a>
                                ...
                                <p style="font-size: 14px; line-height: 140%">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 140%">
                                  <span style="color: #dd0713; font-size: 14px; line-height: 19.6px">contact@truedating.co.uk&nbsp;</span>
                                </p>
