...
export default function Shoreditch({ events, locations, ages }) {
  return (
    <div id="home-page">
      <Head>
        <title>Speed Dating Shoreditch | True Dating</title>
        <meta
          name="description"
          content="Connect with the right people with Speed Dating Shoreditch! True Dating is your best help and guidance to find your love in a fun and relaxed environment."
        />
        <meta name="keywords" content="Speed Dating Shoreditch" />
      </Head>
      <section id="home_banner">
        ...
        >
          ...
          <Typography color="white">Shoreditch</Typography>
        </Breadcrumbs>
        <div className="row">
          <div className="column">
            <div className="content ml-2">
              <h1>Speed Dating Shoreditch</h1>
              <h2>
          ...
          <Grid container spacing={4}>
            ...
            >
              <Image
                ...
                alt="Best Speed Dating Shoreditch"
              />
            </Grid>
            <Grid
              item
            ...
            >
              <h2>Fun Speed Dating in Shoreditch: How Does It Work?</h2>
              <br />
              <Image
                src={bestSpeedDatingClapham}
                alt="Best Speed Dating Shoreditch"
              ...
              <p>
                ...
                <br />
                <br />
                Shoreditch is the perfect location for speed dating events
                because it’s a hub for creativity, entrepreneurs, and people
                with alternative lifestyles. So if you’re ready to experience a
                fun and exciting way to date, join True Dating today.
                <br />
                <br />
      ...
      <Box>
        <section id="partners">
          ...
          <div className="row">
            <div>
              <Image src={speedDatingClapham} alt="Speed Dating Shoreditch" />
            </div>
            <div>
              <Image src={claphamSpeedDating} alt="Shoreditch Speed Dating" />
            </div>
            <div>
              <Image
                src={speedDatingEventsClapham}
                alt="Speed Dating Events Shoreditch"
              />
            </div>
            <div>
              <Image
                src={claphamSpeedDatingEvents}
                alt="Shoreditch Speed Dating Events"
              />
            </div>
            <div>
              <Image
