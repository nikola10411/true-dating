...
export default function LondonBridge({ events, locations, ages }) {
  return (
    <div id="home-page">
      <Head>
        <title>Speed Dating London Bridge | True Dating</title>
        <meta
          name="description"
          content="Connect with the right people with Speed Dating London Bridge! True Dating is your best help and guidance to find your love in a fun and relaxed environment."
        />
        <meta name="keywords" content="Speed Dating London Bridge" />
      </Head>
      <section id="home_banner">
        ...
        >
          ...
          <Typography color="white">London Bridge</Typography>
        </Breadcrumbs>
        <div className="row">
          <div className="column">
            <div className="content ml-2">
              <h1>Speed Dating London Bridge</h1>
              <h2>
                It’s not always easy to find a partner, right? Thus, it can be
                hard to find someone that will want to know more about you and
                get into a relationship. That is why speed dating is such a
                great solution for single people who need to find love.
                <br />
                <br />
                ...
                passion. With our speed dating events in London Bridge, you have
                the perfect opportunity to meet new people and possibly spark
                romance.
              </h2>
          ...
          <Grid container spacing={4}>
            ...
            >
              <Image
                ...
                alt="Best Speed Dating London Bridge"
              />
            </Grid>
            <Grid
              item
          ...
          <Grid container spacing={4}>
            ...
            >
              ...
              <Image
                ...
                alt="Singles Events London Bridge"
              />
              <br />
              <p>
              ...
              <p>
                ...
                easy to find romance in London Bridge, so get on board today and
      ...
      <Box>
        <section id="partners">
          ...
          <div className="row">
            <div>
              <Image
                src={speedDatingClapham}
                alt="Speed Dating London Bridge"
              />
            </div>
            <div>
              <Image
                src={claphamSpeedDating}
                alt="London Bridge Speed Dating"
              />
            </div>
            <div>
              <Image
                src={speedDatingEventsClapham}
                alt="Speed Dating Events London Bridge"
              />
            </div>
            <div>
              <Image
                src={claphamSpeedDatingEvents}
                alt="London Bridge Speed Dating Events"
              />
            </div>
            <div>
              <Image
