...
export default function Hammersmith({ events, locations, ages }) {
  return (
    <div id="home-page">
      <Head>
        <title>Speed Dating Hammersmith | True Dating</title>
        <meta
          name="description"
          content="Connect with the right people with Speed Dating Hammersmith! True Dating is your best help and guidance to find your love in a fun and relaxed environment."
        />
        <meta name="keywords" content="Speed Dating Hammersmith" />
      </Head>
      <section id="home_banner">
        ...
        >
          ...
          <Typography color="white">Hammersmith</Typography>
        </Breadcrumbs>
        <div className="row">
          <div className="column">
            <div className="content ml-2">
              <h1>Speed Dating Hammersmith</h1>
              <h2>
          ...
          <Grid container spacing={4}>
            ...
            >
              <Image
                ...
                alt="Best Speed Dating Hammersmith"
              />
            </Grid>
            <Grid
              item
          ...
          <Grid container spacing={4}>
            ...
            >
              ...
              <Image
                ...
                alt="Singles Events Hammersmith"
              />
              <br />
              <p>
      ...
      <Box>
        <section id="partners">
          ...
          <div className="row">
            <div>
              <Image src={speedDatingClapham} alt="Speed Dating Hammersmith" />
            </div>
            <div>
              <Image src={claphamSpeedDating} alt="Hammersmith Speed Dating" />
            </div>
            <div>
              <Image
                src={speedDatingEventsClapham}
                alt="Speed Dating Events Hammersmith"
              />
            </div>
            <div>
              <Image
                src={claphamSpeedDatingEvents}
                alt="Hammersmith Speed Dating Events"
              />
            </div>
            <div>
              <Image
