...
export default function Soho({ events, locations, ages }) {
  return (
    <div id="home-page">
      <Head>
        <title>Speed Dating Soho | True Dating</title>
        <meta
          name="description"
          content="Connect with the right people with Speed Dating Soho! True Dating is your best help and guidance to find your love in a fun and relaxed environment."
        />
        <meta name="keywords" content="Speed Dating Soho" />
      </Head>
      <section id="home_banner">
        ...
        >
          ...
          <Typography color="white">Soho</Typography>
        </Breadcrumbs>
        <div className="row">
          <div className="column">
            <div className="content ml-2">
              <h1>Speed Dating Soho</h1>
              <h2>
                ...
                life in Soho, read on and learn why speed dating is the
        ...
        <Container>
          <Grid container spacing={4}>
            ...
            >
              ...
              <Image src={singlesEventClampham} alt="Singles Events Soho" />
              <br />
              <p>
      ...
      <Box>
        <section id="partners">
          ...
          <div className="row">
            <div>
              <Image src={speedDatingClapham} alt="Speed Dating Soho" />
            </div>
            <div>
              <Image src={claphamSpeedDating} alt="Soho Speed Dating" />
            </div>
            <div>
              <Image
                src={speedDatingEventsClapham}
                alt="Speed Dating Events Soho"
              />
            </div>
            <div>
              <Image
                src={claphamSpeedDatingEvents}
                alt="Soho Speed Dating Events"
              />
            </div>
            <div>
              <Image
